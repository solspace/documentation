...
description: Date and time formatting reference for Calendar 1.x for ExpressionEngine, covering relative text dates, numeric formats, dynamic year/month/day substitutions, and time formatting syntax.
---

...
description: Guide for configuring member group permissions in Calendar 1.x for ExpressionEngine, covering per-calendar access controls and the three permission behavior options for the EE control panel.
---

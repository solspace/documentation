...
description: Full changelog for Calendar 1.x for ExpressionEngine, listing all releases from 1.0.0 through 1.8.14 with added features, bug fixes, and compatibility updates.
---

---
sidebar_position: 1
description: Requirements, installation, and update instructions for Calendar 1.x for ExpressionEngine 2, including file placement, channel setup, and control panel configuration steps.
---

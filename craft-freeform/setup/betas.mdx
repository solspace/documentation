...
Official headless packages (`@solspace/freeform-react`, `@solspace/freeform-vue`, and related packages) ship on npm — see [Headless → Getting Started](../headless/getting-started.mdx).

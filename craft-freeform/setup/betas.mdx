...
<h3 className="yellow">Stay tuned for the next Freeform beta!</h3>
...
Feel free to also just use a [Private Support Ticket](https://support.solspace.com/) or report an issue via [GitHub Issues](https://github.com/solspace/craft-freeform/issues).
...
<Photo
  img={require('@site/static/img/craft/freeform/v5/cp_beta-feedback-widget-closed.png')}
  alt="Beta Feedback Widget"
/>
<Photo
  img={require('@site/static/img/craft/freeform/v5/cp_beta-feedback-widget-open.png')}
...
- [Private Support Ticket](https://support.solspace.com/)

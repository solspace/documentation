...
Click on the _**EXPRESS** / trial_ button beside Freeform's name and when it takes you to the Plugin Store page, scroll down to the bottom and click on the **Try** button for the _Pro_ edition (see video below).

<Player
  url={
    require('@site/static/videos/craft/freeform/v5/switch-edition.mp4').default
  }
  muted
  loop
  playing

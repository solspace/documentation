...
sidebar_position: 2
description: Learn how to create custom field types for Freeform 5.x in Craft CMS, including registration, templates, and advanced features.
---
...
See our [Field Properties](./field-properties/index.mdx) document for a comprehensive list of available property types you can use in your custom field types.

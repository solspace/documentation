---
sidebar_position: 7
description: Extend Freeform 5.x CRM integrations in Craft CMS using events for before/after processing, mapping, and handling submission data sent to CRM services.
---

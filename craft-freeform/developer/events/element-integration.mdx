---
sidebar_position: 6
description: Use Freeform 5.x Element Integration events in Craft CMS to hook into Element creation, saving, and deletion processes (e.g., Entries, Users, Assets triggered by form submissions).
---

---
sidebar_position: 8
description: Extend Freeform 5.x Email Marketing integrations in Craft CMS using events for before/after processing, mapping, and handling submission data sent to email marketing services.
---

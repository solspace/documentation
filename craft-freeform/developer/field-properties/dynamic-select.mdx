...
description: Dynamic Select field property for Freeform 5.x custom fields in Craft CMS.
---

import { Badge, BadgeGroup, Photo } from '@site/src/components/utils';

The `#[DynamicSelect]` property type will render a dropdown that populates its options from an endpoint.
...
#### Result
<Photo
  img={require('@site/static/img/craft/freeform/v5/developer/field-properties/dynamic-select.png')}
  alt="Dynamic Select Property Editor Preview"
  unscaled
/>
<Photo
  img={require('@site/static/img/craft/freeform/v5/developer/field-properties/dynamic-select-response.png')}
  alt="Dynamic Select Response"
  unscaled
/>

...
sidebar_position: 6
description: Create and manage predefined options sources for Freeform 5.x fields in Craft CMS (e.g., dynamic lists from Entries, Categories, or custom sources).
---
...
See our [Field Properties](./field-properties/index.mdx) document for a comprehensive list of available property types you can add to your Predefined Options class properties, allowing you to display them as controls in the builder.
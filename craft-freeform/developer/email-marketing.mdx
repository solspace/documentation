...
sidebar_position: 4
description: Build custom Email Marketing integrations for Freeform 5.x in Craft CMS, including the integration class, settings, mapping, and submission handling.
---
...
```php showLineNumbers title="/modules/ApiMock/server.php"
<?php
...
```php showLineNumbers title="/modules/EmailMarketing/CustomEmailMarketingIntegration.php"
<?php

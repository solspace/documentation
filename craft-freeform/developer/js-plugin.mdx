...
Freeform loads external scripts such as IMask, Flatpickr, reCAPTCHA, etc.
If you are in need of altering something for the script tags, that can be done via the `freeform-script-before-load` event.

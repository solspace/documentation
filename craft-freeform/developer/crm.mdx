...
sidebar_position: 3
description: Build custom CRM integrations for Freeform 5.x in Craft CMS, including the integration class, settings, mapping, and submission handling.
---
...
```php showLineNumbers title="/modules/CRM/CustomCrmIntegration.php"
<?php

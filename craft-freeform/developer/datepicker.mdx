...
sidebar_position: 10
description: Date Picker events reference for Freeform 5.x in Craft CMS, covering how to customize the built-in flatpickr instance before and after initialization via the Freeform JS plugin.
---

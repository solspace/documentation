---
sidebar_position: 8
description: Freeform API reference for Freeform 5.x in Craft CMS, covering how to fetch forms and submissions, create submissions programmatically, and refresh honeypots for cached pages.
---

...
sidebar_position: 4
description: Guide for submitting file uploads to a headless Freeform 5.x form in Craft CMS using Next.js and AJAX, including GraphQL Base64 file handling.
---

---
sidebar_position: 4
description: Guide for preserving line breaks in Freeform 5.x textarea field submissions using Twig's nl2br filter in Craft CMS email notifications and templates.
---

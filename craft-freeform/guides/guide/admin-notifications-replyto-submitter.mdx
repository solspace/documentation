---
sidebar_position: 2
description: Guide for setting the form submitter's email address as the Reply-to in Freeform 5.x admin email notifications for Craft CMS, enabling easy email replies.
---

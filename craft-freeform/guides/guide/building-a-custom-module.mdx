---
sidebar_position: 1
description: Guide for building a custom Craft module that conditionally routes Freeform 5.x email notifications using the EVENT_AFTER_SUBMIT developer event.
---

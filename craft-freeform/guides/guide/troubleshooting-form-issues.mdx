---
sidebar_position: 1
description: Guide for troubleshooting common Freeform 5.x form display, behavior, and submission issues in Craft CMS, including diagnostics, logging, and isolated testing.
---

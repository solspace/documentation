...
- The form is being cached. Freeform is compatible with all kinds of caching, but please see the [Caching](../../guides/guide/caching-forms.mdx) guide to ensure you're following best practices.

---
sidebar_position: 3
description: Guide for storing URL tracking parameters like utm_source and utm_medium in Freeform 5.x form submissions using hidden fields in Craft CMS.
---

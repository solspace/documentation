...
description: Guide for creating a Craft CMS user registration form in Freeform 5.x Pro using the Users element integration, with field mapping and account activation settings.
---
...
- Find _User_ in the list of **service providers**.

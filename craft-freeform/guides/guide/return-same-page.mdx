...
Aside from the obvious of using [AJAX](../../guides/guide/ajax-forms.mdx), you can achieve this by adding a query in the success URL instead of an additional segment, etc.

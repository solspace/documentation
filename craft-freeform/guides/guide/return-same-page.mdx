---
sidebar_position: 6
description: Guide for returning a Freeform 5.x form submission to the same page in Craft CMS using a success query parameter and returnUrl setting.
---

# Returning Submit to Same Page

Aside from the obvious of using [AJAX](../../templates/ajax.mdx), you can achieve this by adding a query in the success URL instead of an additional segment, etc.

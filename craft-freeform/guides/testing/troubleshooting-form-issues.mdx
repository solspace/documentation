...
<details>
<summary class="green">✅ Everything Works?</summary>
...
<details>
<summary class="red">❌ Still Have Issues?</summary>
...
2. Look for any items that are in <span class="red">red</span> and click on them. In the case of the below example, the `contact` item was red.

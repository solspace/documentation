...
<Player   url={require('@site/static/videos/craft/freeform/v5/builder-notifications.mp4').default}
...
<Player   url={require('@site/static/videos/craft/freeform/v5/builder-integrations.mp4').default}

...
sidebar_position: 5
description: Dashboard widgets for Freeform 5.x submissions and forms in Craft CMS.
---
...
<details className="hidden-heading">
  ...
  - **Include Spam Submissions**<Badge type="feature" text="New in 5.15.24+" />
    - Include submissions marked as spam in the chart data.

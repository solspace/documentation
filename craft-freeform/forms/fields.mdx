...
| [Table](#table)<Badge type="feature" text="Improved in 5.8+" />                   | `table`                               | A field that allows you to collect and handle repeating data.                                                                                                      |          <span class="compare-none">✕</span>           |       <span class="compare-none">✕</span>        |       <span class="edition-pro">✓</span>       |

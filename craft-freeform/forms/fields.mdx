...
import CheckboxFieldImg from './assets/img/fields/checkbox.png';
import CheckboxesFieldImg from './assets/img/fields/checkboxes.png';
import ConfirmFieldImg from './assets/img/fields/confirm.png';
import DateTimeFieldImg from './assets/img/fields/date-time.png';
import DropdownFieldImg from './assets/img/fields/dropdown.png';
import EmailFieldImg from './assets/img/fields/email.png';
import FileUploadFieldImg from './assets/img/fields/file-upload.png';
import FileDragDropFieldImg from './assets/img/fields/file-upload-drag-drop.png';
import HTMLRichTextFieldImg from './assets/img/fields/html-rich-text.png';
import MultiSelectFieldImg from './assets/img/fields/multi-select.png';
import NumberFieldImg from './assets/img/fields/number.png';
import OpinionScaleFieldImg from './assets/img/fields/opinion-scale.png';
import PasswordFieldImg from './assets/img/fields/password.png';
import PhoneFieldImg from './assets/img/fields/phone.png';
import RadiosFieldImg from './assets/img/fields/radios.png';
import RatingFieldImg from './assets/img/fields/rating.png';
import RegexFieldImg from './assets/img/fields/regex.png';
import SubmitSaveFieldImg from './assets/img/fields/submit-save.png';
import SignatureFieldImg from './assets/img/fields/signature.png';
import StripeFieldImg from './assets/img/fields/stripe.png';
import TableFieldImg from './assets/img/fields/table.png';
import TableBuilderFieldImg from './assets/img/fields/table-builder.png';
import TextFieldImg from './assets/img/fields/text.png';
import TextareaFieldImg from './assets/img/fields/textarea.png';
import WebsiteFieldImg from './assets/img/fields/website.png';
import SubmitFieldImg from './assets/img/fields/submit.png';
...
<Photo scale={40} img={CheckboxFieldImg} alt="Checkbox" />
...
<Photo img={CheckboxesFieldImg} alt="Checkboxes field type" />
...
<Photo img={ConfirmFieldImg} alt="Confirm field type" />
...
<Photo scale={40} img={DateTimeFieldImg} alt="Date & Time field type" />
...
<Photo img={DropdownFieldImg} alt="Dropdown field type" />
...
<Photo img={EmailFieldImg} alt="Email field type" />
...
<Photo img={FileUploadFieldImg} alt="File Upload field type" />
...
<Photo img={FileDragDropFieldImg} alt="File Upload Drag & Drop field type" />
...
<Photo img={HTMLRichTextFieldImg} alt="HTML field type" />
...
<Photo scale={40} img={MultiSelectFieldImg} alt="Multiple Select field type" />
...
<Photo scale={40} img={NumberFieldImg} alt="Number field type" />
...
<Photo scale={60} img={OpinionScaleFieldImg} alt="Opinion Scale field type" />
...
<Photo img={PasswordFieldImg} alt="Password field type" />
...
<Photo img={PhoneFieldImg} alt="Phone field type" />
...
<Photo img={RadiosFieldImg} alt="Radios field type" />
...
<Photo img={RatingFieldImg} alt="Rating field type" />
...
<Photo scale={50} img={RegexFieldImg} alt="Regex field type" />
...
<Photo img={HTMLRichTextFieldImg} alt="Rich Text field type" />
...
<Photo scale={50} img={SignatureFieldImg} alt="Signature field type" />
...
<Photo img={SubmitFieldImg} alt="Submit Buttons field type" />
...
<Photo img={SubmitSaveFieldImg} alt="Save & Continue Later button" />
...
<Photo img={StripeFieldImg} alt="Stripe Payment field Layout Options" />
...
<Photo img={TableFieldImg} alt="Table field type" />
...
<Photo img={TableBuilderFieldImg} alt="Table field type in form builder" />
...
<Photo img={TextFieldImg} alt="Text field type" />
...
<Photo img={TextareaFieldImg} alt="Textare field type" />
...
<Photo scale={50} img={WebsiteFieldImg} alt="Website field type" />

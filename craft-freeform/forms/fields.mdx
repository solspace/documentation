...
| [Checkbox](#checkbox)                                                             | `checkbox`                            | A single checkbox field.                                                                                                                                           |         <span className="edition-express">✓</span>         |       <span className="edition-lite">✓</span>        |       <span className="edition-pro">✓</span>       |
| [Checkboxes](#checkboxes)                                                         | `checkboxes`                          | A group of checkboxes.                                                                                                                                             |         <span className="edition-express">✓</span>         |       <span className="edition-lite">✓</span>        |       <span className="edition-pro">✓</span>       |
...
| [Rich Text](#rich-text)                                                           | `rich-text`                           | A block that allows you to insert rich text into areas of your form (headings, descriptions, etc).                                                                 |          <span className="compare-none">✕</span>           |       <span className="compare-none">✕</span>        |       <span className="edition-pro">✓</span>       |

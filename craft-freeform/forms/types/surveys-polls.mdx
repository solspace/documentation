...
title: 'Surveys & Polls'
sidebar_position: 1
description: Use the Surveys & Polls form type in Freeform 5.x for Craft CMS to create engaging surveys with specialized fields and reporting features.
---
...
<Photo
  img={require('@site/static/img/craft/freeform/v5/cp/surveys-polls-report.png')}
  alt="Surveys polls report"
/>
...
<Photo
  img={require('@site/static/img/craft/freeform/v5/cp/surveys-polls-dashboard.png')}
  alt="Surveys & Polls Dashboard"
/>
...
<Photo
  img={require('@site/static/img/craft/freeform/v5/forms/surveys-polls.png')}
  alt="Surveys & Polls Settings"
/>
...
<Photo
  img={require('@site/static/img/craft/freeform/v5/forms/templates_surveys-polls-report.png')}

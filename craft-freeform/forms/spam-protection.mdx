...
description: Configure spam protection features in Freeform 5.x for Craft CMS, including honeypot, captchas, throttling, and the Spam Folder.
---
...
## Honeypot<Badge type="feature" text="Improved in 5.0+" />
...
## Javascript Test<Badge type="feature" text="Improved in 5.0+" />
...
- [AI Spam Analysis](../../integrations/ai-spam-analysis)<Badge type="pro" text="Pro" /><Badge type="feature" text="New in 5.12+" />
- [Email Addresses](#email-address-blocking)<Badge type="feature" text="Improved in 5.13+" />
- [Keywords](#keyword-blocking)
- [IP Addresses](#ip-address-blocking)<Badge type="feature" text="Improved in 5.13+" />
- [Gibberish](#gibberish-blocking)<Badge type="feature" text="New in 5.13+" />
...
### Email Address Blocking<Badge type="feature" text="Improved in 5.13+" />

This option allows you to block specific email addresses or domains used in [Email](../forms/fields.mdx#email) field types.

- **Check MX Record**<Badge type="feature" text="New in 5.13+" />
...
### IP Address Blocking<Badge type="feature" text="Improved in 5.13+" />
...
- **Blocked IP Addresses**
  ...
  - The values entered here will apply to all forms that use this integration. Additionally, form-specific blocks can be set inside the form builder.
- **Check DNS Block Lists**<Badge type="feature" text="New in 5.13+" />
...
### Gibberish Blocking<Badge type="feature" text="New in 5.13+" />

This option allows you to block [Gibberish](https://en.wikipedia.org/wiki/Gibberish) values when entered into fields, e.g. `dfsjghdfjkghdsdfg` or `sdfg5769d9gd`.
...
### Friendly Captcha<Badge type="feature" text="Improved in 5.15.10+" />

- [One-Click/Zero-Click/Smart](../integrations/friendly-captcha.mdx)
...
Freeform is compatible with the [Snaptcha plugin](https://plugins.craftcms.com/snaptcha) if you wish to use it for spam protection.

When using AJAX-based forms, you'll need to refresh Snaptcha after each submission to allow users to resubmit the form (for example, if validation fails or they submit multiple times). The Snaptcha docs provide a [guide for this in their AJAX Requests documentation](https://putyourlightson.com/plugins/snaptcha#ajax-requests).

---
sidebar_position: 6
description: Quickly install Freeform demo templates in Craft CMS to explore real-world examples, get a fully functioning demo area, and learn template code faster.
---
...
](../guides/guide/troubleshooting-form-issues.mdx)
:::
...
:::tip
[How do I completely uninstall / remove the demo templates when done?](../guides/guide/remove-demo-templates.mdx)
:::
...
The demo below is a live [demo site](https://demo.solspace.com/freeform-demo/) that shows most of what the Demo Templates include (some sections and data has been limited).

<iframe
  title="App Demo"
  id="app-demo"
  src="https://demo.solspace.com/freeform-demo/"
  scrolling="yes"
  height="1600px"
  width="100%"
  className="app-demo"

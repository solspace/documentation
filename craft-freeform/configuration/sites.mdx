...
| [Cards](../forms/fields.mdx#cards)                                                        | <span className="green">✓</span> |             <span className="green">✓</span>             | <span className="compare-none"><small>N/A</small></span> | <span className="compare-none"><small>N/A</small></span> |             <span className="green">✓</span>             | <span className="compare-none"><small>N/A</small></span> |                                                           <small><span className="green">✓</span>&nbsp;Cards&nbsp;/&nbsp;Card&nbsp;Layout<Badge type="feature" text="5.13+" /><br /><span className="red">✕</span>&nbsp;Max Selected Values<br /><span className="red">✕</span>&nbsp;Cards Per Row</small>                                  |

...
#### Unique _From Email_ per Site

In Craft 5.6+, a new feature called [Site Overrides](https://craftcms.com/docs/5.x/system/mail.html#site-overrides) was added to the Email Settings area. All you need to do is configure the **Site Overrides** feature and Freeform will respect those settings.

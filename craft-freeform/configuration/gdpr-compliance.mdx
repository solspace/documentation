...
description: Guide to making Freeform 5.x forms GDPR compliant in Craft CMS, including consent checkboxes, data storage options, withdrawal of consent, IP address handling, automatic purging, and more.
---

---
sidebar_position: 4
description: Configure Update Notices, Email Failure Alerts, Critical System Error Reports, and Weekly/Daily Digests in Freeform 5.x for Craft CMS to stay informed about issues, updates, and form performance.
---
...
<Player
  url={
    require('@site/static/videos/craft/freeform/v5/notices-alerts.mp4').default
  }
  muted
  loop
  playing
...
<Photo
  img={require('@site/static/img/craft/freeform/v5/configuration/email-alert.png')}
  alt="Email Alert preview"
/>

## Critical System Error Report Recipients<BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup><Badge type="feature" text="New in 5.13+" />

Provide one or more comma-separated email addresses that should receive critical error reports instantly.
...
<Photo
  img={require('@site/static/img/craft/freeform/v5/configuration/digest.png')}

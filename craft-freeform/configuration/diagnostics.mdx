---
sidebar_position: 5
description: Access Freeform's self-diagnostics page in Craft CMS to identify setup issues, verify requirements, and share diagnostic results with Solspace Support.
---

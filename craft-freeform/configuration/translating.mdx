...
If you'd like to share your translation with others, [send us an email](https://support.solspace.com/) with a link to the translation file, and we'll consider including it in the main Solspace Freeform plugin package.

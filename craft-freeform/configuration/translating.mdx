---
sidebar_position: 10
description: Translate Freeform 5.x for Craft CMS — including Site-Aware Forms with per-site translations, control panel strings, front-end templates, AJAX messages, and more.
---

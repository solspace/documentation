...
title: 'Square'
sidebar_position: 33
description: Square integration for Freeform 5.x in Craft CMS.
---
...
# Square<Badge type="pro" text="Pro" /><Badge type="feature" text="New in 5.13+" />
...
Square fields work with Freeform’s official headless React and Vue packages. Configure Square in Freeform as usual, enable the form for headless, and pass `recommendedExtensions` (includes `squarePaymentExtension`).

See **[Headless → React JS → Square payments](../headless/reactjs.mdx#square-payments)** or **[Vue.js → Payments](../headless/vuejs.mdx#payments-stripe-square-paypal-mollie)** for setup, same-origin proxy notes, multipage tips, and how tokenization ties into Freeform’s existing Square payments route.

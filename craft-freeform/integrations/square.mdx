...
See **[Headless → React JS → Square payments](../headless/reactjs.mdx#payments)** or **[Vue.js → Payments](../headless/vuejs.mdx#payments)** for setup, same-origin proxy notes, multipage tips, and how tokenization ties into Freeform’s existing Square payments route.

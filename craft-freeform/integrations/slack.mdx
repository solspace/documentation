...
title: 'Slack'
sidebar_position: 31
description: Slack integration for Freeform 5.x in Craft CMS.
---
...
<Photo
  img={require('@site/static/img/craft/freeform/v5/integrations/slack-app.png')}
  alt="Slack Webhook Integration"
/>
...
- Click the **Create New App** button and fill out the _App Name_ and choose your _Slack Workspace_ and click the **Create App** button.
  {' '}
  <Photo
    img={require('@site/static/img/craft/freeform/v5/integrations/slack-create-1.png')}
    alt="Slack App creation"
  />
...
- On the next page, choose which channel or conversation the submissions should be posted to, and then click **Install**.
  <Photo
    img={require('@site/static/img/craft/freeform/v5/integrations/slack-create-2.png')}
    alt="Slack App creation"
  />
...
- Copy that Webhook URL and save it to your clipboard (e.g. `https://hooks.slack.com/services/GDF765GF7/56DG98GDF/GFSAD675F8DFG7854D4FDF6F`).
  <Photo
    img={require('@site/static/img/craft/freeform/v5/integrations/slack-create-3.png')}
    alt="Slack App creation"
  />
...
- Find _Slack_ in the list of **service providers**.
...
- Click the **Save** button.
  <Photo
    img={require('@site/static/img/craft/freeform/v5/integrations/slack.png')}
    alt="Slack Webhook setup inside Freeform"
  />

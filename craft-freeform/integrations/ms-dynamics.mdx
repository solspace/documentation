...
sidebar_position: 22
description: Microsoft Dynamics 365 integration for Freeform 5.x in Craft CMS.
---

import { Badge, PrimaryButtonWithLink } from '@site/src/components/utils';
import { VerticalStepWrapper, StepMarkdown } from '@site/src/components/docs';

# Microsoft Dynamics 365<Badge type="pro" text="Pro" /><Badge type="addon" text="Beta" /><Badge type="feature" text="New in 5.15.30+" />

Create **Leads** and **Contacts** from Freeform submissions using the Microsoft Dataverse Web API.

:::warning
This integration requires Freeform Pro and a Dynamics 365 commercial cloud environment with the applicable tables installed.
:::

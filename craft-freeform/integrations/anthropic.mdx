...
Once you enable and configure an AI integration, various AI functionality becomes available in Freeform, including the [AI field type](../forms/fields.mdx#ai) becomes available in your forms. Use it to provide a system prompt with instructions for how the model should process submission data (e.g., categorization, summarization, sentiment analysis, content generation). Specify the exact output format you need.
...
- Select the AI model you want to use. The default is `claude-3-5-haiku-latest`.

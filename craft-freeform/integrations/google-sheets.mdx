...
title: 'Google Sheets'
sidebar_position: 15
description: Google Sheets integration for Freeform 5.x in Craft CMS.
---
...
- Find _Google Sheets_ in the list of **service providers**.
...
- Click the **Authorize** button.
  - A popup will load the Google OAuth page to allow permissions.

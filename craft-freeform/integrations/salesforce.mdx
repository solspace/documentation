...
title: 'Salesforce'
sidebar_position: 30
description: Salesforce integration for Freeform 5.x in Craft CMS.
---
...
- **Files**<Badge type="feature" text="New in 5.6.7+" />
  - Map uploaded files to Salesforce and relate them to _Leads_, _Opportunities_, _Accounts_, and _Contacts_.

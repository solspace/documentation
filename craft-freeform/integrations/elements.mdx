...
This integration allows you to map Freeform submission data to [Craft User](https://craftcms.com/docs/5.x/reference/element-types/users.html), essentially creating a powerful [User Registration form](../guides/speciality-forms/user-registration.mdx).
...
:::tip
[Check out our guide for creating User registration forms.](../guides/speciality-forms/user-registration.mdx)
:::

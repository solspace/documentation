...
title: 'Elements'
sidebar_position: 10
description: Elements integration for Freeform 5.x in Craft CMS.
---
...
<details className="hidden-heading">
  ...
  <VerticalStepWrapper>
    <StepMarkdown stepTitle="Create the Integration">
      ...
      - Find _Entry_ in the list of **service providers**.
...
<details className="hidden-heading">
  ...
  <VerticalStepWrapper>
    <StepMarkdown stepTitle="Create the Integration">
      - Go to the [Element section in Freeform Settings](../configuration/settings.mdx#integrations) (**Freeform → Settings → Elements**).

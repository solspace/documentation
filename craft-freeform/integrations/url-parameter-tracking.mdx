...
sidebar_position: 37
description: URL Parameter Tracking integration for Freeform 5.x in Craft CMS.
---
...
<VerticalStepWrapper>
  <StepMarkdown>
    ...
    - **Store in Cookies**<Badge type="feature" text="New in 5.15+" />
      - Save tracked parameters in cookies so they can be reused by Freeform later.
    - **Cookie Lifetime**<Badge type="feature" text="New in 5.15+" />

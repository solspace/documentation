...
sidebar_position: 14
description: Generic Webhooks integration for Freeform 5.x in Craft CMS to send data to custom endpoints.
---
...
- Find _Generic Webhook_ in the list of **service providers**.

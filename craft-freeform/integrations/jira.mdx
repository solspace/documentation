...
title: 'Jira'
sidebar_position: 20
description: Jira integration for Freeform 5.x in Craft CMS.
---
...
- Find _Jira_ in the list of **service providers**.
...
- Click the **Authorize** button.
  - A popup will load the Jira OAuth page to allow permissions.

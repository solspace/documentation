...
title: 'Mailchimp'
sidebar_position: 22
description: Mailchimp integration for Freeform 5.x in Craft CMS.
---
...
- Find _Mailchimp_ in the list of **service providers**.
...
- Click the **Authorize** button.
  - A popup will load the Mailchimp OAuth page to allow permissions.

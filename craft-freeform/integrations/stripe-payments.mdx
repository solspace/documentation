...
See **[Headless → React JS → Stripe payments](../headless/reactjs.mdx#payments)** or **[Vue.js → Payments](../headless/vuejs.mdx#payments)** for setup, same-origin proxy notes, multipage tips, and how Payment Element confirmation ties into Freeform’s existing Stripe callback / webhook.

...
See **[Headless → React JS → Mollie payments](../headless/reactjs.mdx#payments)** or **[Vue.js → Payments](../headless/vuejs.mdx#payments)** for setup, same-origin proxy notes, multipage tips, and how create → submit → hosted checkout ties into Freeform’s existing Mollie callback / webhook.

...
Freeform's new **Form Monitor** service automatically tests and validates your Freeform Pro forms and email notifications to ensure they're working.
...
<small className="!text-gray-500"><sup>1</sup> Tests are attempted roughly every 8 hours.<br /><sup>2</sup> Failed tests will retry within 10 minutes, and if they fail again, will notify you within 15 minutes of the initial fail.</small>

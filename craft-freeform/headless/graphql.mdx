...
| `javascriptTest`<Badge type="feature" text="New in 5.0+" />    | [`FreeformJavascriptTestInterface`](#javascript-test-interface)          | The Javascript Test integration for this form                          |
...
| `postForwarding`<Badge type="feature" text="New in 5.0+" />    | [`FreeformPostForwardingInterface`](#post-forwarding-interface)          | The Post Forwarding integration of the submission    |
| `gtm`<Badge type="feature" text="New in 5.0+" />               | [`FreeformGoogleTagManagerInterface`](#google-tag-manager-gtm-interface) | The Google Tag Manager integration of the submission |
| `javascriptTest`<Badge type="feature" text="New in 5.0+" />    | [`FreeformJavascriptTestInterface`](#javascript-test-interface)          | The Javascript Test integration of the submission    |
...
### Captcha Interface<Badge type="feature" text="Renamed in 5.0+" />
...
| `action`                                                       | `String`  | The Captcha action                                 |
| `errorMessage`                                                 | `String`  | The Captcha custom error message                   |
| `failureBehavior`                                              | `String`  | The Captcha failure behaviour                      |
| `fieldHandle`                                                  | `String`  | The Captcha field handle                           |
| `locale`                                                       | `String`  | The Captcha locale                                 |
| `scoreThreshold`                                               | `String`  | The Captcha score threshold                        |
| `size`                                                         | `String`  | The Captcha size                                   |
| `theme`                                                        | `String`  | The Captcha theme                                  |
| `triggerOnInteract`                                            | `Boolean` | Will the Captcha trigger on interaction            |
| `version`                                                      | `String`  | The Captcha version                                |

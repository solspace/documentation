...
| `siteIds`     | `[Int]`    | Narrow the queried forms by one or more site IDs     |
| `siteHandles` | `[String]` | Narrow the queried forms by one or more site handles |
...
| `siteId`                                                            | `Int`                                                                    | The form's site ID                                                     |
| `siteUid`                                                           | `String`                                                                 | The form's site UID                                                    |
| `siteName`                                                          | `String`                                                                 | The form's site name                                                   |
| `siteHandle`                                                        | `String`                                                                 | The form's site handle                                                 |

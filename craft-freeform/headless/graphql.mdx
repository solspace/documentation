...
| `successBehavior`                                           | `String`                                                             | The form's success behavior                                            |
| `successTemplate`                                           | `String`                                                             | The form's success template                                            |
...
| `duplicateCheck`                                            | `String`                                                             | The form’s duplicate check rule                                        |
| `stopSubmissionsAfter`                                      | `String`                                                             | The form’s stop submissions after date                                 |
...
| `javascriptTest`<Badge type="feature" text="New in 5.0+" /> | [`FreeformJavascriptTestInterface`](#javascript-test-interface)      | The Javascript Test for this form                                      |
...
| `javascriptTest`                                           | [`FreeformJavascriptTestInterface`](#javascript-test-interface)       | The Javascript Test of the submission             |

...
| `javascriptTest`<Badge type="feature" text="New in 5.9.6+" /> | [`FreeformJavascriptTestInterface`](#javascript-test-interface)          | The Javascript Test for this form                                      |
...
| `successBehavior`<Badge type="feature" text="5.9.6+" />       | `String`                                                                 | The form's success behavior                                            |
| `successMessage`                                              | `String`                                                                 | The specified success message                                          |
| `successTemplate`<Badge type="feature" text="5.9.6+" />       | `String`                                                                 | The form's success template                                            |
...
| `duplicateCheck`<Badge type="feature" text="5.9.6+" />        | `String`                                                                 | The form’s duplicate check rule                                        |
| `stopSubmissionsAfter`<Badge type="feature" text="5.9.6+" />  | `String`                                                                 | The form’s stop submissions after date                                 |
| `enctype`                                                     | `String`                                                                 | The form’s enctype                                                     |
| `rules`                                                       | [`FreeformRulesInterface`](#rules-interface)                             | The form’s rules                                                       |
| `postForwarding`<Badge type="feature" text="New in 5.0+" />   | [`FreeformPostForwardingInterface`](#post-forwarding-interface)          | The Post Forwarding integration for this form                          |
| `gtm`<Badge type="feature" text="New in 5.0+" />              | [`FreeformGoogleTagManagerInterface`](#google-tag-manager-gtm-interface) | The Google Tag Manager integration for this form                       |
...
| `javascriptTest`<Badge type="feature" text="5.9.6+" />     | [`FreeformJavascriptTestInterface`](#javascript-test-interface)       | The Javascript Test of the submission             |
...
| `errorMessage`<Badge type="feature" text="5.9.6+" /> | `String` | Error message for Honeypot |
...
### Form Captcha Interface<Badge type="feature" text="Renamed in 5.0+, Improved in 5.9.6+" />
...
| `action`<Badge type="feature" text="5.9.6+" />            | `String`  | The Captcha action                                |
| `errorMessage`<Badge type="feature" text="5.9.6+" />      | `String`  | The Captcha custom error message                  |
| `failureBehavior`<Badge type="feature" text="5.9.6+" />   | `String`  | The Captcha failure behaviour                     |
| `fieldHandle`<Badge type="feature" text="5.9.6+" />       | `String`  | The Captcha field handle                          |
| `locale`<Badge type="feature" text="5.9.6+" />            | `String`  | The Captcha locale                                |
| `scoreThreshold`<Badge type="feature" text="5.9.6+" />    | `String`  | The Captcha score threshold                       |
| `size`<Badge type="feature" text="5.9.6+" />              | `String`  | The Captcha size                                  |
| `theme`<Badge type="feature" text="5.9.6+" />             | `String`  | The Captcha theme                                 |
| `triggerOnInteract`<Badge type="feature" text="5.9.6+" /> | `Boolean` | Will the Captcha trigger on interaction           |
| `version`<Badge type="feature" text="5.9.6+" />           | `String`  | The Captcha version                               |
...
### Google Tag Manager (GTM) Interface<Badge type="feature" text="New in 5.0+" />
...
| `inputName`    | `String` | Input Name of Javascript Test           |

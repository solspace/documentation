...
| `urlParameterTracking`<Badge type="feature" text="New in 5.15.0+" /> | [`FreeformUrlParameterTrackingInterface`](#url-parameter-tracking-interface) | The URL Parameter Tracking integration for this form                   |
...
### URL Parameter Tracking Interface<Badge type="feature" text="New in 5.15.0+" />

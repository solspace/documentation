...
| `captcha`<Badge type="deprecated" text="Deprecated in 6.0+" />      | [`FreeformCaptchaInterface`](#captcha-interface)                         | The captcha for this form                                              |
| `captchas`<Badge type="feature" text="Renamed in 5.0+" />           | [`[FreeformCaptchaInterface]`](#captcha-interface)                       | The captchas for this form                                             |
...
| `postForwarding`<Badge type="feature" text="New in 5.9.6+" />       | [`FreeformPostForwardingInterface`](#post-forwarding-interface)          | The Post Forwarding integration for this form                          |
| `gtm`<Badge type="feature" text="New in 5.9.6+" />                  | [`FreeformGoogleTagManagerInterface`](#google-tag-manager-gtm-interface) | The Google Tag Manager integration for this form                       |
...
| `captcha`<Badge type="deprecated" text="Deprecated in 6.0+" /> | [`FreeformCaptchaInterface`](#captcha-interface)                         | The captcha for this form.                           |
| `captchas`<Badge type="feature" text="New in 5.9.6+" />        | [`[FreeformCaptchaInterface]`](#captcha-interface)                       | The captchas for this form                           |
...
| `postForwarding`<Badge type="feature" text="New in 5.9.6+" />  | [`FreeformPostForwardingInterface`](#post-forwarding-interface)          | The Post Forwarding integration of the submission    |
| `gtm`<Badge type="feature" text="New in 5.9.6+" />             | [`FreeformGoogleTagManagerInterface`](#google-tag-manager-gtm-interface) | The Google Tag Manager integration of the submission |
...
| `value`<Badge type="deprecated" text="Deprecated in 6.0+" /> | `String` | Value of Honeypot.         |
...
| `handle`<Badge type="deprecated" text="Deprecated in 6.0+" />    | `String`  | The forms GraphQL mutation handle for submissions. |
| `enabled`<Badge type="deprecated" text="Deprecated in 6.0+" />   | `Boolean` | Is Captcha enabled for this form.                  |
...
### Post Forwarding Interface<Badge type="feature" text="New in 5.9.6+" />
...
### Google Tag Manager (GTM) Interface<Badge type="feature" text="New in 5.9.6+" />

...
# Getting Started (Headless)<BadgeGroup><Badge type="lite" text="Lite" /><Badge type="pro" text="Pro" /></BadgeGroup><Badge type="feature" text="Improved in 5.16+" />
...
<VerticalStepWrapper>
  ...
  <StepMarkdown stepTitle="Install the npm packages">
    <Tabs>
      <TabItem value="install-packages-react-next" label="React / Next.js" default>
        ```nix
      ...
      <TabItem value="install-packages-vue" label="Vue 3">
        ```nix
        npm install @solspace/freeform-core \
  ...
  <StepMarkdown stepTitle="Render a form">
    <Tabs>
      <TabItem value="render-example-react" label="React" default>
      ...
      <TabItem value="render-example-vue" label="Vue">
        ```html title="ContactForm.vue" showLineNumbers
...
- **Stripe payments** (Payment Element; see [React JS → Stripe](./reactjs.mdx#payments) / [Vue.js → Payments](./vuejs.mdx#payments))
- **Square payments** (Web Payments SDK; see [React JS → Square](./reactjs.mdx#payments) / [Vue.js → Payments](./vuejs.mdx#payments))
- **PayPal payments** (Buttons; see [React JS → PayPal](./reactjs.mdx#payments) / [Vue.js → Payments](./vuejs.mdx#payments))
- **Mollie payments** (hosted checkout redirect; see [React JS → Mollie](./reactjs.mdx#payments) / [Vue.js → Payments](./vuejs.mdx#payments))

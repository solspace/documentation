...
:::tip Example app
Clone the [Freeform Headless React Demo](https://github.com/solspace/freeform-headless-react-demo) to try the packages against your Craft site (REST, GraphQL tab, Save & Continue, table, signature, calculation, Stripe payments, and more).
:::
...
| `@solspace/freeform-extensions` | Captchas, datetime, file drag & drop, calculation, table, signature, Stripe payments |
...
- Other payment gateways (PayPal, Square, Mollie)

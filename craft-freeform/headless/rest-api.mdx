...
Official clients call this for you. Prefer [`@solspace/freeform-react`](./reactjs.mdx#stripe-payments) rather than calling the endpoint by hand.
...
Official clients call this for you. Prefer [`@solspace/freeform-react`](./reactjs.mdx#square-payments) rather than calling the endpoint by hand. This is the same Square charge route used by classic Freeform templates.
...
Official clients call these for you. Prefer [`@solspace/freeform-react`](./reactjs.mdx#paypal-payments) rather than calling the endpoints by hand. These are the same PayPal routes used by classic Freeform templates.
...
Official clients call create for you. Prefer [`@solspace/freeform-react`](./reactjs.mdx#mollie-payments) rather than calling the endpoints by hand. These are the same Mollie routes used by classic Freeform templates.

...
Official clients call this for you. Prefer [`@solspace/freeform-react`](./reactjs.mdx#stripe-payments) or [`@solspace/freeform-vue`](./vuejs.mdx#payments-stripe-square-paypal-mollie) rather than calling the endpoint by hand.
...
Official clients call this for you. Prefer [`@solspace/freeform-react`](./reactjs.mdx#square-payments) or [`@solspace/freeform-vue`](./vuejs.mdx#payments-stripe-square-paypal-mollie) rather than calling the endpoint by hand. This is the same Square charge route used by classic Freeform templates.
...
Official clients call these for you. Prefer [`@solspace/freeform-react`](./reactjs.mdx#paypal-payments) or [`@solspace/freeform-vue`](./vuejs.mdx#payments-stripe-square-paypal-mollie) rather than calling the endpoints by hand. These are the same PayPal routes used by classic Freeform templates.
...
Official clients call create for you. Prefer [`@solspace/freeform-react`](./reactjs.mdx#mollie-payments) or [`@solspace/freeform-vue`](./vuejs.mdx#payments-stripe-square-paypal-mollie) rather than calling the endpoints by hand. These are the same Mollie routes used by classic Freeform templates.
...
- [React JS → Stripe payments](./reactjs.mdx#stripe-payments) — Payment Element in headless React
- [React JS → Square payments](./reactjs.mdx#square-payments) — Web Payments SDK in headless React
- [React JS → PayPal payments](./reactjs.mdx#paypal-payments) — PayPal Buttons in headless React
- [React JS → Mollie payments](./reactjs.mdx#mollie-payments) — hosted checkout redirect in headless React
- [Vue.js → Payments](./vuejs.mdx#payments-stripe-square-paypal-mollie) — same payment extensions in Vue

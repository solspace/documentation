...
Use the official `@solspace/freeform-react` packages. See [Getting Started](./getting-started.mdx) for enabling the headless API. For Vue 3, see [Vue.js](./vuejs.mdx).

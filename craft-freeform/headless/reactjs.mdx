...
Use the official `@solspace/freeform-react` packages (`@beta` npm tag). See [Getting Started](./getting-started.mdx) for enabling the headless API. The Freeform plugin itself is a normal release.
:::

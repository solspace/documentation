...
sidebar_position: 2
title: AJAX Forms
description: Implement AJAX-powered forms with Freeform 5.x in Craft CMS for seamless submissions without page reloads.
---
...
:::info
Be sure to check out the [Javascript plugin](../developer/js-plugin.mdx) documentation, to learn how to further extend Freeform's functionality.
:::

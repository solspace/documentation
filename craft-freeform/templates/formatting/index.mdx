...
| <div className="sample-templates-icon"><Photo img={require('@site/static/icons/integrations/tailwind.png')} alt="Tailwind 4"/> Tailwind 4 Light </div>                                                     | Popular Framework       | An implementation of the Tailwind CSS 4 framework.                                                                                                                                                                         |
| <div className="sample-templates-icon"><Photo img={require('@site/static/icons/integrations/tailwind.png')} alt="Tailwind 4"/> Tailwind 4 Dark </div>                                           | Popular Framework       | An implementation of the Tailwind CSS 4 framework that uses a dark theme.                                                                                                                                                  |

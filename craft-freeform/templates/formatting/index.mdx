...
<FlexCards
  ...
  items={[
    ...
    },
    {
      ...
      description:
        'Get started quickly with customizing your own formatting templates.',
      icon: Icons.CodeIcon,
      fullCardLink: '../../guides/guide/custom-formatting-templates',
    },
    {
...
- [The Custom Formatting Template guide shows how you can quickly get started with customizing your own formatting templates!](../../guides/guide/custom-formatting-templates)
...
<Tabs>
  <TabItem value="code-form-template-helpers" label="With Helpers" default>

    Below is a basic example of how to automate the rendering of your form directly inside a template:
  ...
  <TabItem value="code-form-template-manual" label="Manual with Helpers">

    For ultimate control, forms can be manually built and even include a mix of render helpers:
...
<FlexCards
  ...
  items={[
    ...
    {
      title: 'Vue.js',
      description: 'Official Vue packages for headless Freeform forms.',
      icon: Icons.VuejsIcon,
      fullCardLink: '../../headless/vuejs/',
    },
    {
      title: 'Nuxt',
      description: 'Official Vue packages in Nuxt with a client-only Freeform setup.',
      icon: Icons.VuejsIcon,
      fullCardLink: '../../headless/nuxt/',
    },
    {
      title: 'React JS',
...
Freeform offers a wide variety of sample _formatting templates_. You can use them as-is, modify them to fit your needs, or create your own from scratch.

:::tip
[If you wish to create your own modified version of one of the sample formatting templates, please see the _Custom Formatting Template_ guide](../../guides/guide/custom-formatting-templates)
:::

| Template Name                                                                                                                                                   | Type                                          | Description                                                                                                                                                                                                                |
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <div className="sample-templates-icon"><img src="/icons/integrations/solspace-freeform.svg" alt="Freeform" />[Basic Light](./plug-and-play.mdx)</div>           | <span className="nowrap">Plug-and-play</span> | A neatly styled basic _light mode_ formatting template.                                                                                                                                                                    |
| <div className="sample-templates-icon"><img src="/icons/integrations/solspace-freeform.svg" alt="Freeform" />[Basic Dark](./plug-and-play.mdx)</div>            | <span className="nowrap">Plug-and-play</span> | A neatly styled basic _dark mode_ formatting template.                                                                                                                                                                     |
| <div className="sample-templates-icon"><img src="/icons/integrations/solspace-freeform.svg" alt="Freeform" />[Basic Floating Labels](./plug-and-play.mdx)</div> | <span className="nowrap">Plug-and-play</span> | A neatly styled basic formatting template that displays labels in the center of the inputs and shrinks them to the top-left when clicked and/or contains a value.                                                          |
| <div className="sample-templates-icon"><img src="/icons/integrations/solspace-freeform.svg" alt="Freeform" />[Conversational](./plug-and-play.mdx)</div>        | <span className="nowrap">Plug-and-play</span> | A neatly styled basic formatting template that displays one field at a time and smoothly scrolls down to the next question until complete. Similar to how _Typeform_ displays forms. Also a great choice for survey forms. |
| <div className="sample-templates-icon"><img src="/icons/integrations/solspace-freeform.svg" alt="Freeform" />[Multipage All Fields](./plug-and-play.mdx)</div>  | <span className="nowrap">Plug-and-play</span> | A neatly styled basic formatting template that displays ALL fields for a multipage form for the purpose of reviewing/previewing fields on other pages.                                                                     |
| <div className="sample-templates-icon"><img src="/icons/integrations/grid.svg" alt="Unstyled" />[Grid](./unstyled.mdx)</div>                                    | Unstyled                                      | A very basic starter template that requires additional CSS to style it.                                                                                                                                                    |
| <div className="sample-templates-icon"><img src="/icons/integrations/grid.svg" alt="Unstyled" />[Flexbox](./unstyled.mdx)</div>                                 | Unstyled                                      | A very basic starter template that requires additional CSS to style it.                                                                                                                                                    |
| <div className="sample-templates-icon"><img src="/icons/integrations/bootstrap.svg" alt="Bootstrap" />[Bootstrap 5](./bootstrap.mdx) </div>                     | Framework                                     | An implementation of the Bootstrap 5 framework that uses the light theme.                                                                                                                                                  |
| <div className="sample-templates-icon"><img src="/icons/integrations/bootstrap.svg" alt="Bootstrap" />[Bootstrap 5 Dark Mode](./bootstrap.mdx) </div>           | Framework                                     | An implementation of the Bootstrap 5 framework that uses the dark theme.                                                                                                                                                   |
| <div className="sample-templates-icon"><img src="/icons/integrations/bootstrap.svg" alt="Bootstrap" />[Bootstrap 5 Floating Labels](./bootstrap.mdx)</div>      | Framework                                     | An implementation of the Bootstrap 5 framework that uses the floating labels feature.                                                                                                                                      |
| <div className="sample-templates-icon"><img src="/icons/integrations/tailwind.svg" alt="Tailwind CSS" />[Tailwind 4 Light](./tailwind.mdx)</div>                | Framework                                     | An implementation of the Tailwind CSS 4 framework that uses a light theme.                                                                                                                                                 |
| <div className="sample-templates-icon"><img src="/icons/integrations/tailwind.svg" alt="Tailwind CSS" />[Tailwind 4 Dark](./tailwind.mdx)</div>                 | Framework                                     | An implementation of the Tailwind CSS 4 framework that uses a dark theme.                                                                                                                                                  |
| <div className="sample-templates-icon"><img src="/icons/integrations/tailwind.svg" alt="Tailwind CSS" />[Tailwind 3 (light)](./tailwind.mdx)</div>              | Framework                                     | An implementation of the Tailwind CSS 3 framework that uses a light theme.                                                                                                                                                 |
| <div className="sample-templates-icon"><img src="/icons/integrations/tailwind.svg" alt="Tailwind CSS" />[Tailwind 3 Dark](./tailwind.mdx)</div>                 | Framework                                     | An implementation of the Tailwind CSS 3 framework that uses a dark theme.                                                                                                                                                  |
| <div className="sample-templates-icon"><img src="/icons/integrations/foundation.svg" alt="Foundation"/>[Foundation 6](./foundation.mdx)<Badge type="deprecated" text="Deprecated" /></div> | Framework                                     | An implementation of the Foundation 6 framework.                                                                                                                                                                           |

:::info

_Plug-and-play_: Neatly styled basic formatting templates that don't require any frameworks or toolkits, etc.<br />
_Unstyled_: Barebones starter templates that require additional CSS to complete the styling.<br />
_Framework_: Formatting templates that are set up to automatically work well with popular frameworks.
...
<Tabs>
  <TabItem value="overrides-attributes" label="Form Attributes" default>
  ...
  <TabItem value="overrides-fields" label="Fields">
    ...
    - `fields` - control overrides for fields.
      ...
      - `"@fieldtypename"` - applied to all fields of this type. Use the field type name prefixed with an `@` symbol. Specify multiples with a comma, e.g. `"@checkboxes, @radios"`.
        - `attributes`
          ...
          - `optionLabel` - applied to `<label>` for all options in _Checkboxes_, _Radios_, _Rating_ and _Opinion Scale_ fields.<Badge type="feature" text="New in 5.10+" />
      ...
      - `"myFieldHandle"` applied to a specific field. Use the field handle name.
        ...
        - `attributes`
          ...
          - `optionLabel` - applied to `<label>` for this specific field's options (applies to _Checkboxes_, _Radios_, _Rating_ and _Opinion Scale_ fields).<Badge type="feature" text="New in 5.10+" />
  ...
  <TabItem value="overrides-captchas" label="Captchas">
...
Submit buttons are automatically inserted at the end of the form by default. However, you can control their appearance in one of the following ways:
...
- `fields`
  - `"@global"`, `"@fieldtypename"`, `"myFieldHandle"`
    - `attributes`
      - `container`, `label`, `optionLabel`, `instructions`

You can also override the default HTML tags from inside of the [Field Attribute Editor](#field-attributes-editor) for the field inside the form builder:

<Photo
  img={require('@site/static/img/craft/freeform/v5/cp/builder-field-attributes.png')}
...
<Tabs>
  ...
  <TabItem value="overriding-html-tags-checkboxes-radios" label="Accessible Checkboxes & Radios">
  ...
  <TabItem value="overriding-html-tags-fields-as-list" label="Fields as a List">

    If you'd like to display your form and its fields as a list (`ul`/`li`), you can do that with the following example:

    - All rows in the form will be switched from the default tag of `div` to `ul`.
    - All field columns (wrappers) will be switched from the default tag of `div` to `li`.
...
<Tabs>
  <TabItem value="set-attributes-form" label="At Form Level" default>
  ...
  <TabItem value="set-attributes-field" label="At Field Level">
  ...
  <TabItem value="set-attributes-anywhere" label="Anywhere">
...
<Tabs>
  ...
  <TabItem value="output" label="Output">
    ...
    <fieldset class="certain-class" data-container>
      <label>
      <input />
    </fieldset>
    ```

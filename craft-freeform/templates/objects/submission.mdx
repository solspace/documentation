---
sidebar_position: 7
description: Submission object reference and properties available in Freeform 5.x templates for Craft CMS.
---
...
### `sourceUrl`<Badge type="feature" text="New in 5.15+" />

The full page URL where the form was submitted. This is captured automatically for each submission.

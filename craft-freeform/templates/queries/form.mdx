...
title: 'Form Queries'
sidebar_position: 1
description: Form query methods and parameters for retrieving forms in Freeform 5.x templates for Craft CMS.
---
...
- `honeypots: true`<Badge type="feature" text="New in 5.0+" /> - disable the Honeypot
- `javascriptTest: true`<Badge type="feature" text="New in 5.0+" /> - disable the Javascript Test

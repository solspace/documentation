...
sidebar_position: 5
description: Submissions query for retrieving and displaying form submissions in Freeform 5.x templates for Craft CMS.
---
...
Display submissions flagged as spam, e.g. `isSpam: true`.

...
description: Calendar:ICS_Subscription template tag reference for Calendar 5.x for ExpressionEngine, covering how to provide a live ICS feed for subscribing to calendars in Google Calendar, Apple Calendar, and Outlook.
---

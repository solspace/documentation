...
description: Calendar fieldtype reference for use within EE Channel:Entries in Calendar 5.x for ExpressionEngine, covering the recurrences variable pair, parameters, variables, and single event and list examples.
---

...
sidebar_position: 5
title: 'Day'
description: Calendar:Day template tag reference for Calendar 5.x for ExpressionEngine, covering parameters, variables, variable pairs, and conditionals for building day-based calendar views.
---
...
### `date_range_start`
This parameter allows you to specify a particular day to display events for. If this parameter is NOT specified or an incorrect date value is passed to this parameter, the current day will be displayed. Both [standard and easy-to-use text date formatting](../guides/date-formatting.mdx) apply to this parameter.
...
:::info
Can be used within the [`calendar:hours`](#calendarhours) variable pair and OUTSIDE of the [`calendar:events`](#calendarevents) variable pair.
:::
...
This variable displays the total number of _all day_ events (all day or multi-day events).

:::info
Can be used within the [`calendar:all_day_events`](#calendarall_day_events) variable pair and OUTSIDE of the [`calendar:events`](#calendarevents) variable pair.
:::
...
:::info
This variable pair will exclude **all day** and some **multi-day** (ones that started previous day) events. To display these, use the [calendar:all_day_events](#calendarall_day_events) variable pair.
:::

...
sidebar_position: 3
title: 'Month'
description: Calendar:Month template tag reference for Calendar 5.x for ExpressionEngine, covering parameters, variables, variable pairs, and conditionals for building month grid calendar views.
---
...
:::info
Can be used within the [`calendar:weeks`](#calendarweeks) variable pair and OUTSIDE of the [`calendar:events`](#calendarevents) variable pair.
:::

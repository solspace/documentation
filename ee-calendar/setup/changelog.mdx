...
description: Changelog for Solspace Calendar 5.x for ExpressionEngine CMS.
---

import { TitleDate } from '@site/src/components/docs';

## 5.0.6<TitleDate date="2026-09-11" />

### Fixed
- Fixed an issue that could cause memory errors when many event recurrences exist.

## 5.0.5<TitleDate date="2026-05-07" />

### Added
- Added Coilpack support.

...
description: Changelog for Calendar 5.x for ExpressionEngine, listing all releases from 5.0.0 through 5.0.5 with added features, bug fixes, and compatibility updates.
---

---
sidebar_position: 7
description: Security vulnerability disclosure policy for Calendar 5.x for ExpressionEngine, covering reporting guidelines, responsible disclosure, safe harbor, and rewards.
---

---
sidebar_position: 1
description: Installation and update instructions for Solspace AI Assistant 1.x in Craft CMS.
---
...
<FlexCards
  ...
  items={[
    ...
    },
    {
      title: 'Updating',
      description:
        'Instructions for updating from 1.x to newer versions of AI Assistant 1.x.',
...
AI Assistant 1.x supports [Craft 5.x](https://craftcms.com/docs/5.x/requirements.html). It meets mostly the same requirements as listed on the Craft Requirements page.
...
<Tabs>
  <TabItem value="install-cli" label="Composer (CLI)" default>
    AI Assistant can be installed by running the following set of commands in your favorite CLI app: <Badge type="recommended" text="Recommended" />
    ...
    <VerticalStepWrapper>
      ...
      <StepMarkdown stepTitle="Get AI Assistant">
        <Tabs>
      ...
      <StepMarkdown stepTitle="Install AI Assistant">
        <Tabs>
          <TabItem value="install-cli-install-plugin-cli-57" label="CLI" default>
          ...
          <TabItem value="install-cli-install-plugin-cp" label="Control Panel">
            ...
            2. Click the **Cog button** for AI Assistant
            3. Select **Install**.
      ...
      <StepMarkdown stepTitle="Purchase">
        If AI Assistant is right for your site, [purchase a copy](#purchasing) of it through the Plugin Store when you're ready!
      </StepMarkdown>
    </VerticalStepWrapper>
  </TabItem>
    ...
    <VerticalStepWrapper>
      ...
      <StepMarkdown stepTitle="Choose Edition">
        ...
        <Photo
          ...
          alt="Plugin Store - Install AI Assistant"
        />
      </StepMarkdown>
      <StepMarkdown stepTitle="Purchase">
        If AI Assistant is right for your site, [purchase a copy](#purchasing) of it through the Plugin Store when you're ready!
...
<Tabs>
  <TabItem value="update-cli" label="Craft Update (CLI)" default>
    You can use the Craft [_update_ command](https://craftcms.com/docs/5.x/update.html#updating-from-the-terminal) to update AI Assistant. <Badge type="recommended" text="Recommended" />
    ...
    <VerticalStepWrapper>
      <StepMarkdown stepTitle="Update composer.json">
        <Tabs>
          ...
          <TabItem value="updating-cli-composer-locked-versions" label="Locked Versions">
            If you are locking your versions, you will need to open your Craft site's main `composer.json` file and adjust the version number for AI Assistant ([see guide below](#understanding-versions-and-composer-update)).
      ...
      <StepMarkdown stepTitle="Run Migrations">
        <Tabs>
          ...
          <TabItem value="updating-cli-composer-aiassistant" label="AI Assistant only">
            ```nix
...
<Tabs>
  <TabItem value="disable-plugin-cli" label="CLI" default>
    <VerticalStepWrapper>
      ...
      <StepMarkdown stepTitle="Disable AI Assistant">
        ```nix
...
<Tabs>
  <TabItem value="uninstall-plugin-cli" label="CLI" default>
    <VerticalStepWrapper>
      ...
      <StepMarkdown stepTitle="Uninstall AI Assistant">
        ```nix
...
<Tabs>
  ...
  <TabItem value="purchasing-purchasing" label="Purchasing">
    ...
    <VerticalStepWrapper>
      ...
      <StepMarkdown>
        Once purchased, the current trial license key for the AI Assistant will become valid. These product keys can also be accessed and managed later on in your [Craft Console account](https://console.craftcms.com) by visiting the **Plugins** area.
      </StepMarkdown>
    </VerticalStepWrapper>
...
- You can also use `~` and `^` to somewhat automate your updating process.
  ...
  - `^1.0.0` - means this version & any _minor_ release (up to `1.99̅.99̅`)
    - Specifying `"solspace/craft-aiassistant": "^1.0.0",` for example, would always get you the latest version of AI Assistant **1.x** (e.g. `1.1.9`), but never the next _major_ version of AI Assistant like **2.x**.
...
<details className="hidden-heading">
  ...
  Sometimes you need to update your site to use the latest _unreleased_ changes in the AI Assistant repository. This could be in the main branch or a temporary fix/feat branch, e.g. `v1` or `feat/SFT-123`.
  <br />
...
<details className="hidden-heading">
  ...
  2. Under **Licenses** → **Plugins**, look for the _AI Assistant_ (or affected plugin) license in the list and confirm it's tied to the correct Craft CMS license. If not, click into the license (e.g. `CRZ6`) and click on the _Detach from this Craft license_ button. This will release it from being attached to the wrong or orphaned Craft CMS license and allow you to enter it into the Craft install you're using.

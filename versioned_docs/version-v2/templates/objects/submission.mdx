...
- `statusModel` <a href="#prop-statusmodel" id="prop-statusmodel" className="docs-anchor">#</a>
...
- `ip` <a href="#prop-ip" id="prop-ip" className="docs-anchor">#</a>
  - The IP address of the submitter, if [collection of IP addresses is enabled](../../forms/builder.mdx#submission-collect-ip)
- `token` <a href="#prop-token" id="prop-token" className="docs-anchor">#</a>

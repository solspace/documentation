...
<Photo
  img={require('@site/static/img/craft/freeform/v2/submissions/submissions-list.png')}
  alt="Submissions"
/>
<Photo
  img={require('@site/static/img/craft/freeform/v2/submissions/submissions-edit.png')}

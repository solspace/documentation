...
<Photo
  img={require('@site/static/img/craft/freeform/v2/configuration/general.png')}
  alt="General Settings"
/>

- **Custom Plugin Name** <a href="#custom-name" id="custom-name" className="docs-anchor">#</a>
  - Override the plugin name by specifying your own here.
- **Show Composer Tutorial** <a href="#composer-tutorial" id="composer-tutorial" className="docs-anchor">#</a>
...
- **Default view** <a href="#default-view" id="default-view" className="docs-anchor">#</a>
  ...
  - Options are:
    ...
    - Forms
    - Submissions
- **Display Order of Fields in Composer** <a href="#composer-display-order" id="composer-display-order" className="docs-anchor">#</a>
  - The display order for the list of available fields in Composer:
    - **Field type, Field name (alphabetical)**
    - **Field name (alphabetical)**
- **Render HTML inside Composer & Submissions view?**<Badge type="feature" text="2.5.0+" /> <a href="#composer-render-html" id="composer-render-html" className="docs-anchor">#</a>
...
- **Include Default Freeform Formatting Templates** <a href="#include-default-templates" id="include-default-templates" className="docs-anchor">#</a>
  - Disable this to hide the default Freeform formatting templates in the Formatting Template options list inside Composer.
- **Remove Newlines from Textareas for Exporting** <a href="#remove-newlines-exporting" id="remove-newlines-exporting" className="docs-anchor">#</a>
  - Enable this to have newlines removed from Textarea fields in submissions when exporting.
- **Disable Submit Button on Form Submit?** <a href="#disable-submit" id="disable-submit" className="docs-anchor">#</a>
...
- **Automatically Scroll to Form on Errors and Multipage forms?** <a href="#auto-scroll" id="auto-scroll" className="docs-anchor">#</a>
...
- **Freeform Javascript Insertion Location** <a href="#scripts-location" id="scripts-location" className="docs-anchor">#</a>
  - The location of where you want Freeform to insert it's scripts for form and field functionality (such as spam protection and advanced field types). This setting should be set to **Inside Form** to work with AJAX.
    - **Page Footer**
    - **Inside Form**
- **Automatically Purge Submission Data**<Badge type="feature" text="2.0.1+" /> <a href="#auto-purge-data" id="auto-purge-data" className="docs-anchor">#</a>
...
- **Directory Path** <a href="#formatting-directory-path" id="formatting-directory-path" className="docs-anchor">#</a>
...
<Photo
  img={require('@site/static/img/craft/freeform/v2/configuration/cp_settings-formatting-templates.png')}
...
- **Directory Path** <a href="#email-directory-path" id="email-directory-path" className="docs-anchor">#</a>
  - Provide a relative path to craft root to your custom form templates directory.
    - E.g. **templates/freeform_emails**
  - To add a starter example template, click the "Add a sample template" button, and then edit the template after.
- **Default Email Notification Creation Method** <a href="#default-email-method" id="default-email-method" className="docs-anchor">#</a>
...
<Photo
  img={require('@site/static/img/craft/freeform/v2/configuration/cp_settings-email-templates.png')}
...
<Photo
  img={require('@site/static/img/craft/freeform/v2/configuration/cp_settings-status-list.png')}
  alt="Statuses"
/>
<Photo
  img={require('@site/static/img/craft/freeform/v2/configuration/cp_settings-statuses-edit.png')}
  alt="Create a Status"
/>
...
- **Freeform Honeypot / Javascript detection** <a href="#honeypot" id="honeypot" className="docs-anchor">#</a>
...
- **Spam Protection Behavior** <a href="#spam-behavior" id="spam-behavior" className="docs-anchor">#</a>
  - Select the behavior you'd like Freeform to take when it detects a submission as being spam:
    ...
    - **Reload form**
- **Use Spam Folder** <a href="#spam-folder" id="spam-folder" className="docs-anchor">#</a>
  ...
  - **Automatically Purge Spam Submissions**<Badge type="feature" text="2.0.1+" /> <a href="#auto-purge-spam" id="auto-purge-spam" className="docs-anchor">#</a>
...
- **Block Email addresses** <a href="#block-email" id="block-email" className="docs-anchor">#</a>
...
- **Block Keywords** <a href="#block-keywords" id="block-keywords" className="docs-anchor">#</a>
...
- **Block IP addresses** <a href="#block-ip" id="block-ip" className="docs-anchor">#</a>
  - Enter IP addresses you would like blocked. Separate multiples on new lines.
- **Form Submission Throttling** <a href="#throttling" id="throttling" className="docs-anchor">#</a>
...
<Photo
  img={require('@site/static/img/craft/freeform/v2/configuration/settings-spam.png')}
  alt="Spam Settings"
/>
...
- **_Enable reCAPTCHA_**<Badge type="pro" text="Pro" /> <a href="#enable-recaptcha" id="enable-recaptcha" className="docs-anchor">#</a>
...
<Photo
  img={require('@site/static/img/craft/freeform/v2/configuration/cp_settings-recaptcha.png')}
  alt="Captcha Settings"
/>

## API Integrations

- _Mailing Lists_<Badge type="pro" text="Pro" /> <a href="#mailing-lists" id="mailing-lists" className="docs-anchor">#</a>
  ...
  - To connect to a mailing list API, click the **New Mailing List Integration** at the top right.
    - View the [Mailing List API Integration](../integrations/index.mdx#mailing-lists-integration) documentation for more information about setting up and configuring.

<Photo
  img={require('@site/static/img/craft/freeform/v2/configuration/cp_settings-email-marketing.png')}
  alt="Email marketing"
/>

- _CRM_<Badge type="pro" text="Pro" /> <a href="#crm" id="crm" className="docs-anchor">#</a>
  ...
  - To connect to a CRM API, click the **New CRM Integration** at the top right.
    - View the [CRM API Integration](../integrations/index.mdx#crm) documentation for more information about setting up and configuring.

<Photo
  img={require('@site/static/img/craft/freeform/v2/configuration/cp_settings-crm.png')}
  alt="CRM"
/>
...
<Photo
  img={require('@site/static/img/craft/freeform/v2/configuration/cp_settings-error-log.png')}
  alt="Error Log"
/>

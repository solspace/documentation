...
Please purchase Freeform 2.x (Lite/Pro) via the [Craft Plugin Store website](https://plugins.craftcms.com/freeform) and then [contact us](https://support.solspace.com/) for a Craft 2.x copy of the plugin.

<a href="https://plugins.craftcms.com/freeform/" className="button button-sm">
...
6. [Contact Solspace Support](https://support.solspace.com/) and provide us the plugin license key(s) and we'll get back to you quickly with the Craft 2.x compatible version of Freeform.

In the future, whenever you're ready to update your site to Craft 3.x, you'll have immediate access to Freeform 2.x for Craft 3.x as well as a valid license for it (within 1 year of purchase), so you won't need to contact us in the future to have the license transferred, etc.
...
2. Locate your existing _Freeform Lite 1.x_ license in your list of purchases and click the _Switch to Freeform Pro_ **Add** button next to it to add the upgrade to your account.
   <Photo
     img={require('@site/static/img/craft/freeform/v1/setup/purchase_solspace.png')}
     alt="Upgrading 1.x Lite to Pro"
   />
...
If you run into any issues, or the _Upgrade_ add to cart button isn't showing, please [contact Solspace Support](https://support.solspace.com/) for assistance.

...
Constant Contact API integrations are a little uglier since they include another layer of API calls by using _Mashery_ API Management. You essentially have to connect Constant Contact to Mashery, and then Mashery to Freeform. Don't trust your instincts and just follow the steps below closely and it won't be as bad as it looks.

1. Sign up for a _Mashery_ API Management account:
...
4. Prepare your site's end for Integration:
   - Go to the [Mailing Lists section in Freeform Settings](../configuration/settings.mdx#api-integrations) (**Freeform > Settings > Mailing Lists**)

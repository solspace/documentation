...
<Photo
  img={require('@site/static/img/craft/freeform/v1/submissions/submissions-list.png')}
  alt="Submissions"
/>
<Photo
  img={require('@site/static/img/craft/freeform/v1/submissions/submissions-edit.png')}
  alt="Edit Submissions"
/>

## Exporting Submissions

Freeform includes 3 options for exporting (2 of which are Pro only). Please refer to the [Exporting](./exporting.mdx) documentation for more information.

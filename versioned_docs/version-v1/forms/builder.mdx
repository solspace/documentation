...
<Photo
  img={require('@site/static/img/craft/freeform/v1/forms/form-builder.png')}
  alt="Form Builder"
/>
<Photo
  img={require('@site/static/img/craft/freeform/v1/forms/form-builder-1.png')}
  alt="Form Builder 1"
/>
<Photo
  img={require('@site/static/img/craft/freeform/v1/forms/form-builder-2.png')}
  alt="Form Builder 2"
/>
<Photo
  img={require('@site/static/img/craft/freeform/v1/forms/form-builder-3.png')}
  alt="Form Builder 3"
/>
...
* **Store Submitted Data** <a href="#submission-store-data" id="submission-store-data" className="docs-anchor">#</a>
  - This setting allows you to specify whether the submission data for this form should be stored in the database or not.
    - Typical use-cases for not storing submission data on your site would be if you just wanted the [email notification](./email-notifications.mdx) and/or wanted the data submitted over to a [Mailing List](../integrations/index.mdx#email-marketing) or [CRM](../integrations/index.mdx#crm) API.
...
* **Return URL** <a href="#form-return-url" id="form-return-url" className="docs-anchor">#</a>
  ...
  - May contain `{{ form.handle }}` and/or `{{ submission.id }}` to parse the newly created unique submission ID in the URL. This would allow you to use the [freeform.submissions](../templates/queries/submissions.mdx) template function to display some or all of the users' submission on the success page.
...
<Photo
  img={require('@site/static/img/craft/freeform/v1/forms/mailinglist.png')}
...
If you have installed and configured any [CRM API integrations](../configuration/settings.mdx#crm) (Customer Relationship Management), you will see a **CRM** button at the top of the **Property Editor** area (right column). To configure this, click that button, and then select an integration name from the options. You may then map out your Freeform fields to your CRM's fields.

...
:::info
**If you're using a Freeform version <u>older</u> than 3.10**, please [click here to view the v3.9 documentation](./js-plugin-v3-9.mdx) that shows the old approach for usage of the Freeform Javascript plugin.
:::

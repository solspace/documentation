...
- [Dynamic Recipients](../forms/email-notifications.mdx#dynamic-recipients)
...
- [Dynamic Template Notifications](../forms/email-notifications.mdx#dynamic-template-notifications)
  - At the template level with the `dynamicNotification` parameter in the [Form query](../templates/queries/form.mdx).
- [User/Submitter Notifications](../forms/email-notifications.mdx#user-submitter-notifications)
...
- [CRMs](../integrations/index.mdx#crm)
- [Email Marketing](../integrations/index.mdx#email-marketing)
- [Stripe Payments](../integrations/index.mdx#other)
- [Webhooks](../integrations/index.mdx#webhooks)
- [POST Forwarding](../integrations/index.mdx#other)
- [Craft Elements](../integrations/index.mdx#craft-elements)

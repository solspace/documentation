...
<Photo
  img={require('@site/static/img/craft/freeform/v3/submissions/fieldtype-create.png')}
...
<Photo
  img={require('@site/static/img/craft/freeform/v3/submissions/fieldtype-entry.png')}
  alt="Using Fieldtype"
/>

...
<span className="yellow">↻ Improved</span> &nbsp;|&nbsp; <span className="red">
  × Removed
...
| Ability to rename the plugin                 |                            <span className="red">×</span>                             |                            <span className="gray">✓</span>                            |
...
First things first, for Craft 3, you cannot use your old Solspace-generated license for Freeform. You'll need to [contact us](https://support.solspace.com/) to have a new Craft Plugin Store specific license generated for you. Please [let us know](https://support.solspace.com/) the following info:
...
4. Follow the regular [installation instructions for Freeform 3.x](./installing-updating.mdx#installing-instructions). You essentially have to "install" Freeform again as if it's a fresh install, but Freeform/Craft will detect that you have old Freeform data in the database and perform a migration instead of a fresh install. You have the following options for installing Freeform 3 on Craft 3:
   - [Install from the Control Panel](./installing-updating.mdx#install-from-the-control-panel)
   - [Installing from the Terminal](./installing-updating.mdx#installing-from-the-terminal)
5. Once installed, you can paste in your new Freeform 3 license into the license key area beside the plugin name (**Craft CP** -> **Settings** -> **Plugins**). By default, you'll be given access to the _Lite_ edition. If you have a _Pro_ license, or wish to trial it or upgrade to it eventually, follow the steps below:
   - Click on the **Lite** flag/button beside the plugin name, which will take you to the Freeform product page inside the Craft Plugin Store.
     <Photo
       ...
       alt="Switch edition after install - step 1"
     />
   - Click on the **Reactivate** (or **Try**) button to activate the _Pro_ edition for your site.
     <Photo
       ...
       alt="Switch edition after install - step 2"
     />

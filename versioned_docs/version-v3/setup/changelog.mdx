...
## 3.13.38<TitleDate date="2024-09-25" />
...
- Fixed a bug where the ActiveCampaign mailing list integration was not pulling in all mailing lists above 100.
...
- Fixed a bug where the ActiveCampaign mailing list API integration was limited to fetching 50 mailing lists.
...
### Added
- Added ActiveCampaign CRM API integration (Pro edition).

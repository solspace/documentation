...
<Photo
  img={require('@site/static/img/craft/freeform/v4/forms/surveys-polls-report.png')}
...
<Photo
  img={require('@site/static/img/craft/freeform/v4/forms/surveys-polls-dashboard.png')}
...
<Photo
  img={require('@site/static/img/craft/freeform/v4/forms/surveys-polls-report-2.png')}
  alt="Surveys & Polls Report"
/>
...
<Photo
  img={require('@site/static/img/craft/freeform/v4/forms/surveys-polls-settings.png')}

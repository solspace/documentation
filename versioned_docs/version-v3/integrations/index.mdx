...
<IconCards
  items={[
    ...
    },
    {
      ...
      iconTitle: 'Hire Us',
      link: '/support/custom-development',
      extraContent: 'Hire Us',
    },
  ]}
/>

Not seeing one that you need? [Hire us](/support/custom-development/) to build one custom for
your needs.
...
Not seeing one that you need? [Hire us](/support/custom-development/) to build one custom for your needs.

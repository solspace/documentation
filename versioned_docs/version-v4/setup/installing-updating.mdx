...
<Photo
  img={require('@site/static/img/craft/freeform/v5/cp/install-1.png')}
  alt="Install Freeform"
/>
Craft will automatically install the _Lite_ edition of Freeform. If you'd like the
_Pro_ edition, you can switch the edition 1 of 2 ways:
...
- **From CP**: Click on the _Lite / trial_ button beside Freeform's name and when it takes you to the Plugin Store page, scroll down to the bottom and click on the **Try** button for the _Pro_ edition (see screenshots below).
  {' '}
  <Photo
    img={require('@site/static/img/craft/freeform/v5/cp/install-2.png')}
    alt="Install Freeform - Badge"
  />
  <Photo
    img={require('@site/static/img/craft/freeform/v5/cp/install-3.png')}
    alt="Install Freeform - Done"
  />
...
:::warning
**If you're upgrading from Freeform 3.x**, please see the special [upgrade guide here](./updating-freeform-3.mdx).
:::
...
<Photo
  img={require('@site/static/img/craft/freeform/v5/cp/switch-editions-trial-1.png')}
  alt="Switch edition trial"
/>
<Photo
  img={require('@site/static/img/craft/freeform/v5/cp/switch-editions-trial-2.png')}
  alt="Switch edition trial 2"
/>
...
<Photo
  img={require('@site/static/img/craft/freeform/v5/cp/switch-editions-purchase-1.png')}
  alt="Switch edition after purchase 1"
/>
<Photo
  img={require('@site/static/img/craft/freeform/v5/cp/switch-editions-purchase-2.png')}
  alt="Switch edition after purchase 2"
/>
...
<Photo
  ...
  alt="Switch edition after purchase 3"
/>

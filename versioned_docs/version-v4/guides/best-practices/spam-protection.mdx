...
1. [reCAPTCHA](../../forms/spam-protection.mdx#captchas) or [hCaptcha](../../forms/spam-protection.mdx#captchas)
2. Freeform Honeypot and [Javascript Enhancement](../../forms/spam-protection.mdx#javascript-enhancement)
   - Be careful when using the JS enhancement setting, as it could cause issues for you when you're caching the site and/or using something like _Vue.js_. Be sure to check out the [overview and warnings about it here](../../forms/spam-protection.mdx#javascript-enhancement).
3. Freeform Honeypot
...
Though not always necessary, we strongly recommend using [reCAPTCHA](../../forms/spam-protection.mdx#captchas) or [hCaptcha](../../forms/spam-protection.mdx#captchas) on your forms to offer the most robust spam protection.
...
:::warning
We strongly recommend using [reCAPTCHA](../../forms/spam-protection.mdx#captchas) or [hCaptcha](../../forms/spam-protection.mdx#captchas) on your forms to offer the most robust spam protection. However, the express guide below gets basic protection for your site.
:::
...
It may also be necessary to use [reCAPTCHA](../../forms/spam-protection.mdx#captchas) or [hCaptcha](../../forms/spam-protection.mdx#captchas) on your forms to offer the most robust spam protection.

...
<Photo
  img={require('@site/static/img/craft/freeform/v4/cp/form-builder-fields.png')}
...
<Photo
  img={require('@site/static/img/craft/freeform/v4/forms/fields/dynamic-recipients.png')}
...
<Photo
  img={require('@site/static/img/craft/freeform/v4/forms/fields/radio-group.png')}
...
<Photo
  img={require('@site/static/img/craft/freeform/v4/cp_forms-composer-feeders-elements.png')}
  alt="Element Feeders"
/>
...
<Photo
  img={require('@site/static/img/craft/freeform/v4/cp_forms-composer-feeders-predefined.png')}

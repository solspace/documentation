...
<Photo
  img={require('@site/static/img/craft/freeform/v4/cp_forms-composer-multipage.png')}
  alt="Form Builder - Multi-page"
/>
<Photo
  img={require('@site/static/img/craft/freeform/v4/templates_form-multipage.png')}
  alt="Form"
/>

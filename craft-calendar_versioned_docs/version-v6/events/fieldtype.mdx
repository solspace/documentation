...
description: Calendar Events Field Type for relating events to other elements in Craft CMS.
---
...
<Photo
  img={require('@site/static/img/craft/calendar/v5/cp_fieldtype-create.png')}
...
<Photo
  img={require('@site/static/img/craft/calendar/v5/cp_fieldtype-entry1.png')}
  alt="Using Fieldtype"
/>
<Photo
  img={require('@site/static/img/craft/calendar/v5/cp_fieldtype-entry2.png')}
  alt="Using Fieldtype"
/>

### Use in Templates

You add the Calendar Event fieldtype to your template code just like you would for any other field. Continuing off the example above (with handle of _relatedEvents_), your code would look something like this:

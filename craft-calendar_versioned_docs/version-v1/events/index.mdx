...
description: Managing events in Solspace Calendar 1.x for Craft CMS.
---
...
<Photo
  img={require('@site/static/img/craft/calendar/v1/cp_month.png')}
  alt="Month Events view with Side bar"
/>

<Photo
  img={require('@site/static/img/craft/calendar/v1/cp_week.png')}
...
<Photo
  img={require('@site/static/img/craft/calendar/v1/cp_quickevent.png')}
...
<Photo
  img={require('@site/static/img/craft/calendar/v1/cp_events.png')}
  alt="Events List"
/>

<Photo
  img={require('@site/static/img/craft/calendar/v1/cp_event-create2.png')}
  alt="Create a New Event"
/>

<Photo
  img={require('@site/static/img/craft/calendar/v1/cp_event-create1.png')}
  alt="Create a New Event"
/>

<Photo
  img={require('@site/static/img/craft/calendar/v1/cp_event-live-preview.png')}
  alt="Live Preview"
/>
...
- **Start Date** & **Time** (required)
  - Datepicker & timepicker in 15, 30 or 60 minute increments.
- **End Date** & **Time** (required)
  - Datepicker & timepicker in 15, 30 or 60 minute increments. If this is a recurring event, this would be the end date and time of the first occurrence.
...
Because _Solspace Calendar_ is an Element Type, you're able to assign/relate events to other element types such as Entries and even other events themselves.

To create and use the _Solspace Calendar_ Event fieldtype, refer to the [Fieldtype](./fieldtype.mdx) documentation.

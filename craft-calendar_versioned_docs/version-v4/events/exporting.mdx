...
description: Exporting events and calendars from Solspace Calendar 4.x in Craft CMS.
---
...
## ICS Export<Badge type="pro" text="Pro" />
...
## ICS Subscriptions<Badge type="pro" text="Pro" />

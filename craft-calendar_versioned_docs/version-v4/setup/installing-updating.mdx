---
sidebar_position: 1
description: Installation and update guide for Solspace Calendar 4.x in Craft CMS.
---
...
Calendar meets mostly the same requirements as listed on the [Craft Requirements](https://craftcms.com/docs/4.x/requirements.html) page.
...
```sh
composer require solspace/craft-calendar
```

To load a specific version, use:

```sh
composer require solspace/craft-calendar:4.0.2
```

</StepMarkdown>
<StepMarkdown>
In the Craft control panel, go to _Settings → Plugins_ and click the **Cog button** for Calendar and select **Install**.
...
Click on the _**LITE** / trial_ button beside Calendar's name and when it takes you to the Plugin Store page, scroll down to the bottom and click on the **Try** button for the _Pro_ edition.

<Photo
  img={require('@site/static/img/craft/calendar/v4/cp_terminal-install.png')}
  alt="Plugin Store - Install Calendar From CP"
/>
...
- You can also use `~` and `^` to somewhat automate your updating process.
  ...
  - `^1.0.0` - means this version & any _minor_ release (up to `1.99̅.99̅`)
    - Specifying `"solspace/craft-calendar": "^4.0.0",` for example, would always get you the latest version of Calendar **4.x** (e.g. `4.1.9`), but never a next _major_ version of Calendar like **5.x**.
...
<Photo
  img={require('@site/static/img/craft/calendar/v4/cp_switch-editions-trial-1.png')}
  alt="Switch edition during trial - step 1"
/>

<Photo
  img={require('@site/static/img/craft/calendar/v4/cp_switch-editions-trial-2.png')}
  alt="Switch edition during trial - step 1"
/>
...
<Photo
  img={require('@site/static/img/craft/calendar/v4/cp_switch-editions-purchase-1.png')}
  alt="Switch edition after Purchase - step 1"
/>

<Photo
  img={require('@site/static/img/craft/calendar/v4/cp_switch-editions-purchase-2.png')}
  alt="Switch edition after Purchase - step 2"
/>

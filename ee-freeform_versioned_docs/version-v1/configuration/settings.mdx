...
<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_settings-general.png')}
  alt="General Settings"
/>

The settings allow you to adjust:

- _License_ <a href="#license" id="license" className="docs-anchor">#</a>
  - **License key** <a href="#license-key" id="license-key" className="docs-anchor">#</a>
...
- _General_ <a href="#general" id="general" className="docs-anchor">#</a>
  - **Spam Protection** <a href="#spam-protection" id="spam-protection" className="docs-anchor">#</a>
  ...
  - **Spam protection simulates a successful submission?** <a href="#spam-simulate-success" id="spam-simulate-success" className="docs-anchor">#</a>
  ...
  - **Session Storage Mechanism** <a href="#session-storage" id="session-storage" className="docs-anchor">#</a>
    - Choose the mechanism with which session data is stored on front end submissions:
      - **PHP Sessions** (default)
      - **Database**
  - **Display Order of Fields in Composer** <a href="#display-order" id="display-order" className="docs-anchor">#</a>
...
- _Formatting Templates_ <a href="#formatting-templates" id="formatting-templates" className="docs-anchor">#</a>
...
<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_settings-formatting-templates.png')}
  alt="Formatting Templates"
/>

- _Email Templates_ <a href="#email-templates" id="email-templates" className="docs-anchor">#</a>
...
- _Statuses_ <a href="#statuses" id="statuses" className="docs-anchor">#</a>
  - This area allows you to manage and create new statuses for your forms.
    ...
    - Ability to add/edit/remove statuses is not available in the _Freeform Express_ edition.
...
- _Demo Templates_ <a href="#demo-templates" id="demo-templates" className="docs-anchor">#</a>
...
- _reCAPTCHA_ (Pro only) <a href="#recaptcha" id="recaptcha" className="docs-anchor">#</a>
  - **Enable reCAPTCHA** <a href="#enable-recaptcha" id="enable-recaptcha" className="docs-anchor">#</a>
    - Enable this setting and fill in the reCAPTCHA _Site Key_ and _Secret Key_ to enable reCAPTCHA v2 Checkbox for Freeform. Then, to add reCAPTCHA v2 Checkbox to your forms, open up and edit each form and drag over the **reCAPTCHA** special field anywhere you like into your form layout.

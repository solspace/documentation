...
Freeform uses its own set of fields and field types. Using a predefined set of fields also gives us the control to more easily account for how each form field should be displayed in Composer's live preview, and provides a smoother experience. The _Freeform Express_ edition has a limit of 15 fields.

:::warning
There is currently a limitation of around 85-125 Freeform fields for each install of ExpressionEngine, due to the MySQL column limit, since all fields are stored in a single table. The limit is different for everyone, due to field types chosen, database encoding, etc. However, Freeform fields can be used across all forms, and even be relabelled for each form.
:::
...
- [Populating Fields with EE Data & Predefined Options](#populating-fields-with-ee-data-predefined-options)
  - [Available Fields](#available-fields)
  - [Available EE Data](#available-ee-data-types)
...
<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_fields-list.png')}
  alt="Fields"
/>

<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_fields-create.png')}
  alt="Create a Field"
/>
...
- **Text** (`text`) <a href="#fields-text" id="fields-text" className="docs-anchor">#</a>
  - A simple input field.
    - Can be marked as required.
    - Can contain default text and/or placeholder.
    - Can set `maxlength` property.
- **Textarea** (`textarea`) <a href="#fields-textarea" id="fields-textarea" className="docs-anchor">#</a>
...
- **Email** (`email`) <a href="#fields-email" id="fields-email" className="docs-anchor">#</a>
  - An input field that is flagged in Freeform to expect an email address value as well as possibility for receiving email notifications.
    ...
    - Can be marked as required.
    - Can contain default text and/or placeholder.
- **Hidden** (`hidden`) <a href="#fields-hidden" id="fields-hidden" className="docs-anchor">#</a>
  - A hidden field.
...
- **Select** (`select`) <a href="#fields-select" id="fields-select" className="docs-anchor">#</a>
...
- **Multiple Select** (`multiple_select`) <a href="#fields-multiple-select" id="fields-multiple-select" className="docs-anchor">#</a>
  - A multiple select field.
    - Can specify labels (with values assumed) or labels and values (that differ).
    - Can be automatically populated with select [EE Data or Pre-defined list options](#populating-fields-with-ee-data-predefined-options).
    - Can be marked as required.
    - Can specify default option(s) to be selected.
- **Checkbox** (`checkbox`) <a href="#fields-checkbox" id="fields-checkbox" className="docs-anchor">#</a>
...
- **Checkbox Group** (`checkbox_group`) <a href="#fields-checkbox-group" id="fields-checkbox-group" className="docs-anchor">#</a>
  - A group of checkboxes.
    - Can specify labels (with values assumed) or labels and values (that differ).
    - Can be automatically populated with select [EE Data or Pre-defined list options](#populating-fields-with-ee-data-predefined-options).
    - Can be marked as required.
    - Can specify which (if any) options to be checked by default.
- **Radio Group** (`radio_group`) <a href="#fields-radio-group" id="fields-radio-group" className="docs-anchor">#</a>
  - A group of radio options.
    - Can specify labels (with values assumed) or labels and values (that differ).
    - Can be automatically populated with select [EE Data or Pre-defined list options](#populating-fields-with-ee-data-predefined-options).
    - Can be marked as required.
    - Can specify which (if any) option to be selected by default.
- **File Upload** (`file`) <a href="#fields-file-upload" id="fields-file-upload" className="docs-anchor">#</a>
  ...
  - Can allow a single file or multiple files (applies `multiple` attribute to the single file upload input) to be uploaded.
    ...
    - In [multi-page forms](./multi-page-forms.mdx), if an earlier page contains file upload field(s), files will actually be uploaded before the form is officially submitted.
    ...
    - Can be marked as required.
- **Dynamic Recipients** (`dynamic_recipients`) <a href="#fields-dynamic-recipients" id="fields-dynamic-recipients" className="docs-anchor">#</a>
...
<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_field-confirm.png')}
  alt="Confirmation fieldtype"
/>
...
<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_field-datetime.png')}
...
<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_field-number.png')}
  alt="Number fieldtype"
/>
...
<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_field-phone.png')}
  alt="Phone fieldtype"
/>

- **Table** <a href="#fields-table" id="fields-table" className="docs-anchor">#</a>
  - A special field which allows users to enter repeating data rows into predefined columns.

<Photo
  img={require('@site/static/img/ee/freeform/v2/templates_table-field.png')}
  alt="Table fieldtype"
/>
...
<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_field-rating.png')}
  alt="Rating fieldtype"
/>
...
<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_field-regex.png')}
  alt="Regex fieldtype"
/>
...
<Photo
  img={require('@site/static/img/ee/freeform/v2/cp_field-website.png')}
...
- **reCAPTCHA** (Pro) <a href="#fields-recaptcha" id="fields-recaptcha" className="docs-anchor">#</a>
  ...
  - _reCAPTCHA_ fields will render automatically like the rest of your fields in your form, but if you're building a form manually, you'd call it like this (using the Hash value for _reCAPTCHA_ field in Property Editor of Composer): `{field:grecaptcha_MD1KzPw68:render}`

...
sidebar_position: 5
description: Integrate FullCalendar.js with Solspace Calendar 5.x in Craft CMS.
---
...
<Photo
  img={require('@site/static/img/craft/calendar/v5/templates_fullcal-month.png')}
  alt="FullCalendar JS library - Month view"
/>
<Photo
  img={require('@site/static/img/craft/calendar/v5/templates_fullcal-week.png')}
  alt="FullCalendar JS library - Month view"
/>
